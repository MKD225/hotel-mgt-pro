		...
		$("#jqxgrid").jqxGrid(
				{
					 width: '100%',
			            ...
			            theme: theme,
					columns : [
							{text : 'Name',datafield : 'name',align : 'left'},
							{text : 'Licence No',datafield : 'licenceNo',align : 'left'},
							{text : 'Address',datafield : 'address',align : 'left'},						
							{text : 'emailAddress',datafield : 'emailAddress',align : 'left'},
							{text : 'Telephone Number',datafield : 'telephoneNumber',align : 'left'},
							...
							
							{
								...
								buttonclick : function(row) {
									...
									var dataRecord = $("#jqxgrid").jqxGrid(
											'getrowdata', row);
									$("#externalDriverIdEdit").val(dataRecord.externalDriverId);
									$("#nameEdit").val(dataRecord.name);											
									$("#licenceNoEdit").val(dataRecord.licenceNo);				
									$("#addressEdit").val(dataRecord.address);
									$("#emailAddressEdit").val(dataRecord.country);
...
// 									$("#fname:text").val(dataRecord.firstName);
									...
									$("#externalDriverIdView").val(dataRecord.externaldriverId);
									
									$("#nameView").val(dataRecord.name);
																				
									$("#licenceNoView").val(dataRecord.licenceNo);
		...
		<table>
			...
			<tr>
				<td colspan="2" align="center">&nbsp;<input type="hidden"
					id="externalDriverIdEdit" name="externalDriverId" readonly="readonly" /></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" id="telephoneNumberEdit" name="telephoneNumber"
		...
		<form method="post" action="" id="externaldriverViewForm">
			<table>
				...
				<tr>
					...
					<td colspan="2"><input type="hidden" id="externalDriverIdView"
						name="externalDriverId" class="text-input" readonly="readonly" /></td>
				</tr>
				<tr>
					<td>Name :</td>
				...
				<tr>
					<td>Email Address</td>
					<td><input type="text" id="emailAddressView" name="emailAddress"
						class="text-input" readonly="readonly" /></td>
				</tr>
				<tr>
					<td>Telephone Number :</td>
